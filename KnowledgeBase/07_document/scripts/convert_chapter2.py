...
OUTPUT_PATH = os.path.join(DOC_DIR, "Chapter2_LiteratureReview.docx")
...
def main():
    print("📖 Starting conversion of Chapter 2 markdown report to formatted Word document...")
    doc = Document()
    ...
    # Define Chapter 2 file path
    chapter2_path = os.path.join(DOC_DIR, "Chapter2_LiteratureReview.md")
    
    if not os.path.exists(chapter2_path):
        print(f"❌ File not found: {chapter2_path}")
        sys.exit(1)
    ...
    for line in lines:
        ...
        elif "ภาพที่" in striped_line and ("**ภาพที่" in striped_line or "ภาพที่ 2." in striped_line):
