...
-- CPUs
INSERT OR IGNORE INTO parts (id, name, category_id, brand, model, specs, price) VALUES
...
INSERT OR IGNORE INTO users (id, username, email, password, avatar_url) VALUES
(1, 'johndoe', 'john@example.com', '$2b$10$tZ3F0lK72Fm5u5L/bV97Eu2t46m6jI52hC4mQoH5e88gT.V6.j7/K', 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=150&q=80'),
(2, 'janedoe', 'jane@example.com', '$2b$10$tZ3F0lK72Fm5u5L/bV97Eu2t46m6jI52hC4mQoH5e88gT.V6.j7/K', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=150&q=80');

-- Seed Products (Active marketplace listings)
INSERT OR IGNORE INTO products (id, seller_id, category_id, part_id, condition, remaining_warranty_months, price, stock_quantity, serial_number, description, status, review_status, suspicious_score, suspicious_reasons) VALUES
