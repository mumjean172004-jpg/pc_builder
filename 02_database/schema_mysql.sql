...
CREATE TABLE users (
    ...
    seller_address_province VARCHAR(255) DEFAULT NULL,
    seller_address_district VARCHAR(255) DEFAULT NULL,
    seller_phone VARCHAR(50) DEFAULT NULL,
    is_seller_verified TINYINT DEFAULT 0,
    seller_id_card VARCHAR(50) DEFAULT NULL,
    seller_full_name VARCHAR(255) DEFAULT NULL,
